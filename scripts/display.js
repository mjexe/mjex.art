		...
		this.menus = {
			...
			'about': {
				text: [
					...
					{line: ' show my work in a styli-  ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: ' zed container that shows  ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: ' what i can do while       ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: ' flexing my other projects ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: '                           ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: '___________________________', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{line: '  back                     ', data: {color: schemes.normal[0], bg: schemes.normal[1], alpha: 0, mask: false}},
					{callback: x => setTimeout(() => this.createPointer(), 500)},
